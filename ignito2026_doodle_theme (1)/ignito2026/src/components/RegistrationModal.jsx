        ...
        >
          ...
          >
            <button
              ...
              className="absolute right-5 top-5 rounded-full p-1.5 text-ink/50 transition hover:bg-ink/10 hover:text-ink"
            >
              <X className="h-5 w-5" />
            </button>
                ...
                <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="reg-program" className="text-sm text-ink/70">
                        Mission / program
                      </label>
                      <select
                        id="reg-program"
                        {...register('program', { required: true })}
                        className="rounded-lg border border-ink/20 bg-paper/60 px-4 py-3 text-sm outline-none transition focus:border-cyan"
                      >
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="reg-name" className="text-sm text-ink/70">
                          Full name
                        </label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full rounded-lg border border-ink/20 bg-paper/60 py-3 pl-9 pr-3 text-sm outline-none transition focus:border-cyan"
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="reg-email" className="text-sm text-ink/70">
                          Email
                        </label>
                        <div className="relative">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="reg-college" className="text-sm text-ink/70">
                          College / institution
                        </label>
                        <div className="relative">
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="reg-team" className="text-sm text-ink/70">
                          Team name (optional)
                        </label>
                        <div className="relative">
                          <Hash className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-ink/40" />
                          <input
                            id="reg-team"
                            {...register('teamName')}
                            className="w-full rounded-lg border border-ink/20 bg-paper/60 py-3 pl-9 pr-3 text-sm outline-none transition focus:border-cyan"
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label htmlFor="reg-size" className="text-sm text-ink/70">
                        Crew size
                      </label>
                      <div className="relative">
                        <Users className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-ink/40" />
                        <select
                          id="reg-size"
                          {...register('teamSize')}
                          className="w-full rounded-lg border border-ink/20 bg-paper/60 py-3 pl-9 pr-3 text-sm outline-none transition focus:border-cyan"
