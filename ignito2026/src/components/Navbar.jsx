    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8" aria-label="Primary">
        ...
        <div className="hidden lg:block">
          <a
            href="#register"
            className="btn-glow rounded-full bg-gradient-to-r from-ion to-plasma px-5 py-2.5 text-sm font-semibold text-white shadow-glow transition hover:scale-105"
          >
            Register
          </a>
        </div>
            ...
            <ul className="flex flex-col gap-1 px-5 py-4">
              ...
              <li className="mt-2">
                <a
                  href="#register"
                  onClick={() => setOpen(false)}
                  className="block rounded-full bg-gradient-to-r from-ion to-plasma px-5 py-3 text-center text-sm font-semibold text-white shadow-glow"
                >
                  Register
                </a>
              </li>
