...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <div
        ref={ringRef}
        className={`pointer-events-none fixed left-0 top-0 z-[9999] -translate-x-1/2 -translate-y-1/2 rounded-full border transition-[width,height,border-color] duration-200 ${
          hovering ? 'h-11 w-11 border-cyan bg-cyan/10' : 'h-7 w-7 border-white/40'
        }`}
        aria-hidden="true"
      />
    </>
